...
<template>
  <div>
      ...
      <button type="button" class="btn btn-primary" @click.prevent="stopVideo()" v-bind:disabled="!isStartRecording" id="btnRetake">HOLD/PAUSE</button>
      <button type="button" class="btn btn-primary" @click.prevent="resumeVideo()" v-bind:disabled="isStartRecording" id="btnRetake">Resume</button>
